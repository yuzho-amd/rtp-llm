...
def http_deps():
    ...
    http_archive(
        name = "torch_rocm",
        sha256 = "f0f127a0e028621a1285fb983afdee155c966fec1405020d278fd448213ee10f",
        urls = [
            "file:///mnt/raid0/zhiqchen/demo/whl/torch-2.8.0+git1a24a85-cp310-cp310-linux_x86_64.whl"
        ],
        type = "zip",
        build_file = clean_dep("//:BUILD.pytorch"),
    )
