    ...
    def load_from_ckpt(cls, ckpt_path: str) -> Optional["QuantizationConfig"]:
        ...
        if quant_method == "quark":
            ...
            if (
                ...
                quant_method = Fp4PerGroupQuarkQuantConfig.get_method()
...
class Fp4PerGroupQuarkQuantConfig(QuarkQuantConfig):
    ...
    @classmethod
    def _from_config(cls, config: Dict[str, Any]) -> "QuantizationConfig":
        return Fp4PerGroupQuarkQuantConfig(**config)
...
DEFAULT_FP4_PER_GROUP_QUARK_QUANT_CONFIG = Fp4PerGroupQuarkQuantConfig(bits=4, is_quanted=False)
...
preset_quant_config = {
    ...
    "FP4_PER_GROUP_QUARK": DEFAULT_FP4_PER_GROUP_QUARK_QUANT_CONFIG,
